...
| 단축키 | 전용키| 용도 |
|------|------|------|
|`[Shift]+[1]`|사용자키 `GAS CHK`|실드가스 밸브를 열어 실드가스 유량 확인|


### 인칭 기능
| 단축키 | 전용키| 용도 | 인칭 속도 |
|------|------|------|------|
|`[Shift]+[2]`|사용자키 `inching`|와이어를 토치 앞쪽으로 송급하여 와이어 길이 조절|키를 누른 후 3초 이내는 저속. <br>3초 이상부터는 고속


### 역인칭 기능
| 단축키 | 전용키| 용도 | 인칭 속도 |
|------|------|------|------|
|`[Shift]+[3]`|사용자키 `retract`|와이어를 되감아 와이어 길이 조절|키를 누른 후 3초 이내는 저속. <br>3초 이상부터는 고속
