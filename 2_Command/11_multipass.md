...
### 설명  
```multipass``` 는 아크 센싱의 경로를 재현하기 위한 멀티패스 용 명령어 입니다. 이 명령어를 이용하면 원래 아크용접 경로에서 원하는 만큼 시프트 시킨 경로를 재현하여 용접할 수 있습니다.   
<br/>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        멀티패스 재현 시 원래 아크 센싱 궤적에서 좌우 방향으로 시프트 할 거리
        (-20 ~ 20)[mm]
      <td>변수</td>
    </tr>
    <tr>
      ...
      <td>
        멀티패스 재현 시 원래 아크 센싱 궤적에서 상하 방향으로 시프트 할 거리
        (-20 ~ 20)[mm]
      <td>변수</td>
    </tr>
    <tr>
      ...
      <td>
        멀티패스 재현 시 원래 아크 센싱 궤적과 반대 방향부터 재생할 것인지 설정
        (0: 정방향, 1: 역방향)
      <td>변수</td>
    </tr>
    <tr>
