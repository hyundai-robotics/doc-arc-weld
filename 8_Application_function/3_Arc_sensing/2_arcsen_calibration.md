...
Step 1. <br>
weaving 명령어의 속성창에서 벽방향을 vertical로 설정하십시오.
...
Step 3. <br>
위 그림과 같이 진입스텝을 가상의 벽 반대방향에서 진입하도록 만들고 시작점과 끝점을 60cm정도 간격을 두고 티칭하십시오. 이때 토치 작업각(Roll 각도)을 45도를 유지하십시오.

Step 4. <br>
자동모드로 실제 아크용접을 수행합니다.

Step 5. <br>
weaving 명령어의 속성창에서 지연시간테이블 탭에 진입하십시오. 좌측하단의 Auto calib 항목을 클릭하면 현재 켈리브레이션된 지연시간을 확인할 수 있습니다.
