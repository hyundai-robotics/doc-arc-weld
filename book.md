...
(2)	수동모드에서 **『시스템』 → 『5: 초기화』 → 『3: 용도설정』** 을 누르면 [그림 1.2.1]과 같이 로봇의 용도, 사용하고자 하는 용접기, 사용자키 및 입출력신호 할당을 설정할 수 있는 대화상자가 나타납니다.

(3)	[그림 1.2.1]은 아크 용접 설정 유효로, **『용접기 정보』** 에서 확인한 용접기 번호를 1번('**효성**')으로 선택한 경우입니다. 이 화면에서 **[용접기 설정]** 을 누르면 사용하고자 하는 용접기의 조건을 설정하는 대화상자로 진입합니다.
...
{% endhint %}# 4. Arc용접기 설정# 4.1 Arc 용접기 통신 연결
...
아크 용접 설정이 디지털이고 용접 시작 조건 대화 상자에서 [보조 조건] 탭을 누르면 다음과 같은 용접 보조 조건 편집 화면이 나타납니다.# 5.5.1 용접 보조 조건 - 재시도
...
13. 입력 신호: 용접기에서 로봇 제어기로 보내주는 신호들. ([시스템 > 5: 초기화 > 3: 용도 설정 > 용접기 설정 - 입력 신호 할당]에서 확인 가능)

14. 출력 신호: 제어기에서 용접기로 보내주는 신호들. ([시스템 > 5: 초기화 > 3: 용도 설정 > 용접기 설정 - 출력 신호 할당]에서 확인 가능)
...
이 기능을 사용하려면 **[창조정 > 선택 > 아크 데이터 그래프]**를 순차적으로 눌러 진입합니다.
...
아크 용접 데이터 그래프 화면 아래 **[Row]** 혹은 **[Col]** 버튼을 눌러 그래프의 줄을 늘릴 수 있습니다. 만약 그래프를 더 확대하고 싶다면, **[SHIFT] + [Row]** 혹은 **[SHIFT] + [Col]**을 눌러 화면을 더 확대하여 볼 수 있습니다.# 8. Arc 용접 응용기능
...
통상적으로 멀티 패스 기능을 사용하기 위해 아크 센싱을 사용하고, 아크 센싱을 사용해 멀티 패스를 진행한다고 할 수 있습니다.# 8.3.1 아크 센싱 개념 및 원리
...
위 그림과 같이 좌측이나 우측으로 쏠린 상태에서는 전류의 개형이 변하고 이를 이용하여 용접선을 좌우로 추종할 수 있습니다. 위빙 중간지점에서의 전류를 이용하여 높이방향 또한 보정할 수 있습니다.# 8.3.2 아크 센싱 지원 사양
